    ...
    <div class="hero-background">
        <div class="container">
            <div class="header-container header">
                <a class="navbar-brand logo" href="#"> <img height="auto" width="400px" class="logo" src="assets/logo.png"/> </a>
                <router-link to="hello"><button class="header-btn bold" type="button"> Read More</button></router-link>
            ...
            <div class="hero row">
                <div class="hero-right col-sm-6 col-sm-6">
                    <h1 class="header-headline bold"> Ticketh <br></h1>
                    <h4 class="header-running-text light"> Introducing Ticketh, a platform for buying and reselling tickets built on the Ethereum blockchain.</h4>
                    <router-link to="hello"><button class="hero-btn bold" type="button"> Read More</button></router-link>
                </div><!--hero-left-->

                <div class="col-sm-6 col-sm-6">
                    <img width="600px" height="auto" src="~@/assets/coin.png"/>
                </div>

                <div><img class="mouse" src="images/mouse.svg"/></div>
